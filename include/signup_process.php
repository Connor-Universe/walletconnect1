...
require 'phpmailer/vendor/autoload.php';
    ...
    $first_name_err = $email_err = $last_name_err = $password_err  = $country_error = $username_err = "";
    $first_name = $email = $last_name = $username = $password  = $country = $birthday = $gender  = $success = $fail = "";
    $verified = 1;
    $status = "active";
...
while($column_email = mysqli_fetch_array($run_email)){
  ...
  <strong>FAILED:</strong> Registration unsuccessful
 </div>";
  } else {
 ...
 <strong>FAILED:</strong> Registration unsuccessful
  ...
  //if validation is satified then create a token for the user 
        ...
        if ($first_name_err == "" and $last_name_err == "" and $email_err == "" and $username_err == "" and $password_err == "" and $country_error ==""){
...
$mail->AddEmbeddedImage('krypto_side_assets/logo.png', 'logo', 'krypto_side_assets/logo.png'); 
                      ...
                      <tr>
                        <td class='mini-block-padding'>
                          <table cellspacing='0' cellpadding='0' width='100%' style='border-collapse:separate !important;'>
                            <tr>
                              <td class='mini-block'>
                                <span class='header-sm'>Gender</span><br />
                                Gender : $gender <br />
                                <br />
                      ...
                      <tr>
                        <td class='mini-block-padding'>
                          <table cellspacing='0' cellpadding='0' width='100%' style='border-collapse:separate !important;'>
                            <tr>
                              <td class='mini-block'>
                                <span class='header-sm'>Identification Info</span><br />
                                Account No : $id_no <br />
                                IP Address : $ip <br />
                                Country : $country <br />
                      ...
                      <tr>
                        <td class='mini-block-padding'>
                          <table cellspacing='0' cellpadding='0' width='100%' style='border-collapse:separate !important;'>
                            <tr>
                              <td class='mini-block'>
                                <span class='header-sm'>Date of birth</span><br />
                                <p> DOB : $birthday</p> <br />
                                <br />
...
//Attach an image file
  ...
  $insert_user = "INSERT INTO users (first_name, last_name , email , gender , username , country , birthday , password_user , ip , token , id_no  ,verified,Status,date) 
  VALUES ('$first_name','$last_name','$email', '$gender ', '$username' , '$country', '$birthday', '$password', '$ip', '$token', '$id_no', '$verified','$status','$date' )";
